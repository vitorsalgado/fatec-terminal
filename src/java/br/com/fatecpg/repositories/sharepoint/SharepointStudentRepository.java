...
public class SharepointStudentRepository implements StudentRepository {
    ...
    @Value(("#{appProperties['fatecSiteListsServicePath']}"))
    ...
    public Student get(String enrollment) {
        ...
        NodeList list = spContext.executeQuery(listsPath, listName, query, viewFields, 1);
    ...
    public History getHistory(String enrollment) {
        ...
        NodeList listDisciplines = spContext.executeQuery(listsPath, disciplinesListName, disciplineQuery, disciplineViewFields);
        ...
        for (HistoryEntry objHistoryEntry : historyEntries) {
            ...
            for (int i = 0; i < listDisciplines.getLength(); i++) {
                ...
                objHistoryEntry.getDiscipline().setWorkload(SharepointFieldsReader.readDoubleField(attributes, "ows_Carga_x0020_Hor_x00e1_ria_x0020_"));
                objHistoryEntry.getDiscipline().setCredits(SharepointFieldsReader.readDoubleField(attributes, "ows_Cr_x00e9_ditos"));
                objHistoryEntry.getDiscipline().setTotalWorkload(SharepointFieldsReader.readDoubleField(attributes, "ows_Carga_x0020_Hor_x00e1_ria_x0020_0"));
            }
